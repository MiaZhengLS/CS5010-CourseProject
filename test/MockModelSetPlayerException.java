 ...
 */
public class MockModelSetPlayerException implements WorldModel {
   ...
   */
  public MockModelSetPlayerException(StringBuilder log, int uniqueCode) {
    this.log = log;
  ...
  public void setPlayers(List<String> name, List<Integer> roomIdx, List<Boolean> isAi) {
    throw new IllegalArgumentException("player name duplicate");
  }
